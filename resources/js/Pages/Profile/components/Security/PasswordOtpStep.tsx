        ...
        <form onSubmit={onSubmit} className="space-y-6 max-w-md mx-auto py-2">
            ...
            <div className="space-y-3 pt-2">
                <button
                    ...
                    className="w-full py-2.5 bg-red-900 hover:bg-red-950 text-white rounded-lg text-xs font-semibold shadow-xs transition-colors border border-red-900 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 cursor-pointer"
                >
                    {isSubmitting ? (
                        <>
                ...
                <div className="flex items-center justify-between pt-1">
                    ...
                    <button
                        ...
                        className="text-xs font-semibold text-red-900 hover:text-red-950 disabled:text-slate-400 disabled:cursor-not-allowed flex items-center gap-1.5 cursor-pointer transition-colors"
                    >
