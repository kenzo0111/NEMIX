        ...
        <div className={`grid grid-cols-1 lg:grid-cols-12 gap-6 ${className}`}>
            ...
            <div className="lg:col-span-4 space-y-6">
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/90 dark:border-slate-800 shadow-2xs overflow-hidden">
                    <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-850/60 flex items-center gap-2">
                        <Shield className="w-4 h-4 text-red-900 dark:text-red-400" />
                    ...
                    <div className="p-5 space-y-4 text-xs">
                        <div className="flex items-start gap-3">
                            <div className="w-7 h-7 rounded-lg bg-red-50 dark:bg-red-950/40 text-red-900 dark:text-red-400 flex items-center justify-center shrink-0 mt-0.5 border border-red-100 dark:border-red-900/50">
                        ...
                        <div className="flex items-start gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
                            <div className="w-7 h-7 rounded-lg bg-amber-50 dark:bg-amber-950/40 text-amber-900 dark:text-amber-400 flex items-center justify-center shrink-0 mt-0.5 border border-amber-200 dark:border-amber-900/50">
                        ...
                        <div className="flex items-start gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
                            <div className="w-7 h-7 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 text-emerald-900 dark:text-emerald-400 flex items-center justify-center shrink-0 mt-0.5 border border-emerald-200 dark:border-emerald-900/50">
                    ...
                    <div className="p-4 bg-slate-50/80 dark:bg-slate-850/60 border-t border-slate-100 dark:border-slate-800 text-[11px] text-slate-500 dark:text-slate-400">
                        Institutional Email: <span className="font-mono font-semibold text-slate-700 dark:text-slate-300">{userEmail || 'Configured address'}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="lg:col-span-8">
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/90 dark:border-slate-800 shadow-2xs overflow-hidden">
                    ...
                    <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-1.5 self-start sm:self-auto bg-slate-100/90 dark:bg-slate-800/80 p-1 rounded-lg border border-slate-200 dark:border-slate-700">
                            {steps.map((s, idx) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`flex items-center gap-1 px-2 py-1 rounded text-[11px] font-semibold transition-all ${
                                            isCurrent
                                                ? 'bg-white dark:bg-slate-900 text-red-950 dark:text-red-300 shadow-2xs border border-slate-200/80 dark:border-slate-700'
                                                : isPast
                                                ? 'text-emerald-700 dark:text-emerald-400'
                                                : 'text-slate-400 dark:text-slate-500'
                                        }`}
                                    >
                                        <s.icon className={`w-3 h-3 ${isCurrent ? 'text-red-900 dark:text-red-400' : isPast ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-400 dark:text-slate-500'}`} />
