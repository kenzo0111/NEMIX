import { DivisionGroup } from './types';

export const FUND_CLUSTER_OPTIONS = [
...
export const FALLBACK_DIVISIONS: DivisionGroup[] = [
    {
        ...
        options: [
            ...
            { value: 'Intellectual Property Management Office', label: 'Intellectual Property Management Office' },
            ...
            { value: 'National Service Training Program (NSTP) Office', label: 'National Service Training Program (NSTP) Office' },
            ...
            { value: 'Office of the Vice President for Research and Extension', label: 'Office of the Vice President for Research and Extension' },
            ...
            { value: 'Queen Pineapple Research and Development Institute', label: 'Queen Pineapple Research and Development Institute' },
            ...
            { value: 'Social Policy Research Center', label: 'Social Policy Research Center' },
...
export const getFundClusterDisplay = (val?: string | null): string => {
    if (!val) return '';
    const match = FUND_CLUSTER_OPTIONS.find((f) => f.value === val || f.label === val);
