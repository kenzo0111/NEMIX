...
export default function InventoryToolbar({
    ...
    return (
        <div className="p-4 sm:px-6 lg:px-8 py-4 sm:py-5 border-b border-gray-200/80 dark:border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gray-50/50 dark:bg-slate-900/50">
            <div>
                <h2 className="text-base font-bold text-gray-900 dark:text-slate-100 font-serif tracking-tight">Inventory Master List</h2>
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-3 w-full md:w-auto">
                ...
                <div className="relative flex-grow sm:w-64">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-4 py-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 text-gray-900 dark:text-slate-100 rounded-md text-xs font-medium focus:border-red-900 focus:ring-1 focus:ring-red-900 shadow-xs placeholder-gray-400 dark:placeholder-slate-500"
                    />
                </div>
                ...
                {isFiltered && (
                    <button
                        ...
                        className="px-2.5 py-2 text-xs font-medium text-gray-600 dark:text-slate-400 hover:text-red-900 dark:hover:text-red-300 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-md transition-colors flex items-center justify-center gap-1.5 min-h-[38px] cursor-pointer"
