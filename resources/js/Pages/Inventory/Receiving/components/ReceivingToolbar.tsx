        ...
        <div className="p-4 sm:px-6 lg:px-8 py-4 sm:py-5 border-b border-gray-200/80 flex flex-col xl:flex-row xl:items-center justify-between gap-4 bg-gray-50/50">
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-3 w-full xl:w-auto">
                ...
                <div className="relative w-full sm:w-64">
                    <label htmlFor="receiving-search-input" className="sr-only">
                    ...
                    <input
                        id="receiving-search-input"
                        type="search"
                        value={searchTerm}
                        onChange={(e) => onSearchChange(e.target.value)}
                        placeholder="Search item or SKU..."
                        aria-label="Search receiving records by item or SKU"
                ...
                <button
                    type="button"
                    onClick={onScanRfid}
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-3.5 py-2 border border-red-900/30 text-red-950 hover:bg-red-50 hover:border-red-900/50 rounded-md font-semibold text-xs transition-colors shadow-2xs cursor-pointer whitespace-nowrap min-h-[38px]"
                >
                    <svg className="w-4 h-4 text-red-950" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            strokeWidth="2"
