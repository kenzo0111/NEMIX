        ...
        <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div className="pt-4 border-t border-gray-200 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2.5">
                ...
                <button
                    type="submit"
                    disabled={processing}
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-semibold text-white bg-red-900 hover:bg-red-950 active:bg-red-900 rounded-md shadow-xs focus:outline-none transition-colors disabled:opacity-50 cursor-pointer"
                >
                    {processing ? (
                        <>
