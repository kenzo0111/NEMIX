        ...
        <Modal show={isOpen} onClose={onClose} maxWidth="md">
            <div className="bg-white rounded-xl overflow-hidden">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {/* Footer */}
                    <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end px-4 sm:px-6 py-3 sm:py-3.5 bg-gray-50 border-t border-gray-200 gap-2.5">
                        <button
                            type="button"
                            onClick={onClose}
