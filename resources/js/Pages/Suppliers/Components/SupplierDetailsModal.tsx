...
export const SupplierDetailsModal: React.FC<SupplierDetailsModalProps> = ({
    ...
    return (
        <Modal show={show} onClose={onClose} maxWidth="2xl" ariaLabel="Supplier Information">
            <div className="relative bg-white rounded-xl overflow-hidden shadow-xl border border-gray-200">
                ...
                <div className="px-4 sm:px-6 py-3.5 sm:py-4 bg-gray-50/80 border-t border-gray-200 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2.5">
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto px-4 py-2 bg-red-950 hover:bg-red-900 active:bg-red-950 text-white rounded-lg text-xs font-semibold transition-colors shadow-2xs inline-flex items-center justify-center gap-1.5 cursor-pointer text-center"
                    >
