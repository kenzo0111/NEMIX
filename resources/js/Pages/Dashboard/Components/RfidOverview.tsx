                ...
                <div className="flex flex-wrap items-start sm:items-center justify-between gap-2.5 pb-3 mb-3 border-b border-gray-100">
                    <div className="flex items-center gap-2 min-w-0">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-xs text-gray-600">Physical asset tracking coverage</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-2">
                    <div className="bg-gray-50/70 border border-gray-100 rounded-md p-3">
                        ...
                        <div className="text-lg font-bold font-mono text-gray-900">
                            ...
                            <span className="text-xs font-normal text-gray-500 ml-1">/ {total.toLocaleString()}</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-50/70 border border-gray-100 rounded-md p-3">
                        ...
                        <div className="text-lg font-bold font-mono text-gray-900">
                            ...
                            <span className="text-xs font-normal text-gray-500 ml-1">items</span>
                        </div>
                    </div>
                </div>
