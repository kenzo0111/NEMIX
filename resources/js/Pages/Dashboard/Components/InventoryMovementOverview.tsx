...
export default function InventoryMovementOverview({
    ...
    return (
        <div className={`bg-white border border-slate-200 rounded-xl p-4 sm:p-5 shadow-xs flex flex-col h-full min-w-0 ${className}`}>
            {/* Header & Controls */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 pb-3.5 border-b border-slate-100 min-w-0">
            ...
            <div className="pt-3.5 flex-1 flex flex-col min-w-0">
                <div className="flex flex-wrap items-center justify-between gap-2.5 mb-2.5">
                    {/* Custom Legend */}
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-[11px] font-medium">
                ...
                <div className="flex-1 min-h-[220px] sm:min-h-[250px] lg:min-h-[280px]">
                    <InventoryMovementChart data={movement} />
                </div>
            </div>

            {/* Concise Period Movement Summary Row */}
            <div className="mt-3.5 pt-3 border-t border-slate-100 grid grid-cols-3 gap-2 sm:gap-3 text-left shrink-0">
