        ...
        <Modal show={show} onClose={onClose} maxWidth="sm" ariaLabel={title}>
            <div className="overflow-hidden rounded-2xl bg-white shadow-2xl">
                ...
                <div className="p-5 sm:p-6 text-center flex flex-col items-center">
                    {type === 'success' && (
                        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-50 border border-emerald-100/80 mb-3.5 text-emerald-600 shadow-2xs">
                    ...
                    {type === 'confirm' && (
                        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-amber-50 border border-amber-100/80 mb-3.5 text-amber-600 shadow-2xs">
                            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {type === 'error' && (
                        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-red-50 border border-red-100/80 mb-3.5 text-red-600 shadow-2xs">
                            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        {type === 'confirm' ? (
                            <>
                                <button
                                    type="button"
                                    onClick={onClose}
                                    className="w-full sm:flex-1 px-4 py-2 bg-white text-gray-700 text-xs font-semibold rounded-lg border border-gray-300 hover:bg-gray-50 shadow-2xs hover:border-gray-400 transition-all cursor-pointer text-center"
                                >
                                    Cancel
                                </button>
                                <button
