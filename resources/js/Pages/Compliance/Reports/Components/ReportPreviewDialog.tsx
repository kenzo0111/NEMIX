...
export const ReportPreviewDialog: React.FC<ReportPreviewDialogProps> = ({
    ...
    return (
        <Modal
            ...
            closeable={true}
            ariaLabel="Official COA Document Inspector"
        >
            <div className="flex max-h-[90vh] flex-col overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-2xl border border-gray-200 dark:border-slate-800 print:max-h-none print:shadow-none print:border-none compliance-print-dialog-panel">
                ...
                <div className="flex items-center justify-between px-4 sm:px-6 py-3.5 sm:py-4 border-b border-gray-200/80 dark:border-slate-800 bg-gradient-to-b from-gray-50/90 to-white dark:from-slate-900 dark:to-slate-900 shrink-0 print:hidden compliance-print-hide">
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <span className="px-2 py-0.5 bg-red-50 dark:bg-red-950/50 border border-red-200/80 dark:border-red-900/40 text-red-900 dark:text-red-300 font-mono font-bold text-[10px] rounded-md tracking-wider">
                                    {report.type}
                                </span>
                            </div>
                    ...
                    <button
                        type="button"
                        onClick={onClose}
                        className="text-gray-400 hover:text-gray-600 dark:hover:text-slate-200 hover:bg-gray-100 dark:hover:bg-slate-800 p-1.5 rounded-lg transition-colors cursor-pointer shrink-0 ml-2"
                ...
                {/* Body */}
                <div className="p-3 sm:p-6 overflow-y-auto flex-1 space-y-4 bg-gray-50/40 dark:bg-slate-950/60 print:p-0 print:overflow-visible print:bg-white print:block print:space-y-0">
                    {/* Report Metadata Summary Card (Read-Only) */}
                    <div className="bg-white dark:bg-slate-900 border border-gray-200/80 dark:border-slate-800 rounded-xl p-4 shadow-2xs print:hidden compliance-print-hide">
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
                            <div className="space-y-0.5">
                                <span className="block text-[10px] font-bold text-gray-400 dark:text-slate-500 uppercase tracking-wider font-mono">
                                    Reference
                                </span>
                                <span className="font-mono font-bold text-gray-900 dark:text-slate-100 text-xs">
                                    {report.reference}
                                </span>
                            </div>
                            <div className="space-y-0.5">
                                ...
                                <span className="font-semibold text-gray-900 dark:text-slate-100 block truncate">
                                    {reportTypeLabel}
                                </span>
                            </div>
                            <div className="space-y-0.5">
                ...
                <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3 px-4 sm:px-6 py-3 sm:py-3.5 bg-gradient-to-b from-white to-gray-50 dark:from-slate-900 dark:to-slate-900 border-t border-gray-200/80 dark:border-slate-800 shrink-0 print:hidden compliance-print-hide">
                    <button
                        type="button"
                        onClick={onClose}
                        className="w-full sm:w-auto px-4 py-2 text-xs font-semibold text-gray-700 dark:text-slate-200 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 shadow-2xs hover:border-gray-400 transition-all cursor-pointer text-center"
                    >
                        Close
                    </button>
