...
export default function ManageAnalytics({ auth }: { auth: any }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100/80 flex font-sans text-gray-900 selection:bg-red-900 selection:text-white">
            ...
            <PageHeader title="Inventory Performance Analytics" description="Live Metrics, Item Valuation, Stock Distribution & Inventory Watchlists" breadcrumbs={[{ name: 'Compliance' }, { name: 'Manage Analytics' }]} />
