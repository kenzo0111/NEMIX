    ...
    return (
        <Modal show={show} onClose={onClose} maxWidth="3xl">
            <div className="flex max-h-[85vh] flex-col overflow-hidden rounded-lg bg-white shadow-xl border border-gray-200">
                ...
                <div className="flex items-center justify-between gap-4 border-b border-gray-200 bg-gray-50 px-6 py-4 flex-shrink-0">
                    <div className="flex items-center gap-2.5">
                        <div className="p-2 rounded bg-red-950 text-amber-300 border border-red-900">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <span>Full Inventory Registry</span>
