...
<td align="center" style="border-radius: 6px; background-color: #800000;">
    <a href="{{ $url }}" class="button button-{{ $color }}" target="_blank" rel="noopener" style="background-color: #800000; border: 12px 22px solid #800000; border-radius: 6px; color: #ffffff !important; display: inline-block; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 15px; font-weight: 700; line-height: 20px; text-decoration: none !important; text-align: center; -webkit-text-size-adjust: none;">
        {!! $slot !!}
    </a>
</td>
</tr>
