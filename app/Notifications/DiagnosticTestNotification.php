...
class DiagnosticTestNotification extends Notification
{
    ...
    {
        $checkIconUrl = \App\Services\MailAssetService::url('images/mail/icon-check.png');
        ...
        $successPanel = new HtmlString(
            ...
            '<td style="width: 24px; vertical-align: top; padding-right: 12px; padding-top: 2px;"><img src="' . $checkIconUrl . '" width="18" height="18" alt="Success" style="width: 18px; height: 18px; display: block; border: 0;"></td>' .
